...
void SceneBlur::compileAndLinkShader()
{
    try {
#ifdef __APPLE__
        prog.compileShader("shader/blur_41.vert",GLSLShader::VERTEX);
        prog.compileShader("shader/blur_41.frag",GLSLShader::FRAGMENT);
#else
        prog.compileShader("shader/blur.vert",GLSLShader::VERTEX);
        prog.compileShader("shader/blur.frag",GLSLShader::FRAGMENT);
#endif
        prog.link();
        prog.use();
