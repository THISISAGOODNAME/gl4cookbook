...
void SceneHdrBloom::compileAndLinkShader()
{
    try {
#ifdef __APPLE__
        prog.compileShader("shader/hdrbloom_41.vert");
        prog.compileShader("shader/hdrbloom_41.frag");
#else
        prog.compileShader("shader/hdrbloom.vert");
        prog.compileShader("shader/hdrbloom.frag");
#endif
        prog.link();
        prog.use();
