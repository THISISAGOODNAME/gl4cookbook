...
void SceneEdge::compileAndLinkShader()
{
    try {
#ifdef __APPLE__
        prog.compileShader("shader/edge_41.vert",GLSLShader::VERTEX);
        prog.compileShader("shader/edge_41.frag",GLSLShader::FRAGMENT);
#else
        prog.compileShader("shader/edge.vert",GLSLShader::VERTEX);
        prog.compileShader("shader/edge.frag",GLSLShader::FRAGMENT);
#endif
        prog.link();
        prog.use();
