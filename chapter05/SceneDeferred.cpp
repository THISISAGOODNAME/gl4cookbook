...
void SceneDeferred::compileAndLinkShader()
{
    try {
#ifdef __APPLE__
        prog.compileShader("shader/deferred_41.vert",GLSLShader::VERTEX);
        prog.compileShader("shader/deferred_41.frag",GLSLShader::FRAGMENT);
#else
        prog.compileShader("shader/deferred.vert",GLSLShader::VERTEX);
        prog.compileShader("shader/deferred.frag",GLSLShader::FRAGMENT);
#endif
        prog.link();
        prog.use();
