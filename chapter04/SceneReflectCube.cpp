...
//    prog.setUniform("ReflectFactor", .0f);
//    prog.setUniform("ReflectFactor", 1.0f);
...
void SceneReflectCube::compileAndLinkShader()
{
    try {
#ifdef __APPLE__
        prog.compileShader("shader/cubemap_reflect_41.vert");
        prog.compileShader("shader/cubemap_reflect_41.frag");
#else
        prog.compileShader("shader/cubemap_reflect.vert");
		prog.compileShader("shader/cubemap_reflect.frag");
#endif
        prog.link();
        prog.use();
