...
void SceneRefractCube::compileAndLinkShader()
{
    try {
#ifdef __APPLE__
        prog.compileShader("shader/cubemap_refract_41.vert");
        prog.compileShader("shader/cubemap_refract_41.frag");
#else
        prog.compileShader("shader/cubemap_refract.vert");
        prog.compileShader("shader/cubemap_refract.frag");
#endif
        prog.link();
        prog.use();
